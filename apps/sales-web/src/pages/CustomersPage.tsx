...
export function CustomersPage() {
  ...
  useEffect(() => { trainingService.getPersonas().then((items) => { setPersonas(items); setLoading(false) }) }, [])
