...
export function TrainingAssignmentCreatePage() {
  ...
  return <div className="mx-auto max-w-3xl space-y-6 pb-8">
    ...
    <PageHeader eyebrow="Quản lý đào tạo" title="Phân công chương trình" description="Chỉ chương trình đã xuất bản và nhân viên SALE đang hoạt động được hiển thị." />
    ...
    <Surface className="border border-border p-5 shadow-subtle sm:p-6"><form className="grid gap-5" onSubmit={(event) => void submit(event)}>
