...
export function DashboardPage() {
  ...
  useEffect(() => { Promise.all([trainingService.getRecommendedPersonas(), trainingService.getRecentSessions()]).then(([nextPersonas, nextSessions]) => { setPersonas(nextPersonas); setSessions(nextSessions); setLoading(false) }) }, [])
